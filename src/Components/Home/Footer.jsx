        ...
        <div>
            <footer className=" flex flex-col py-10 space-y-10 bg-base-200 text-base-content rounded">
                <div className='flex justify-around items-center'>
                    ...
                    <div>
                        <h3 className="text-4xl font-semibold pb-5">Socials</h3>
                        <nav className="grid grid-flow-col gap-4">
                            <a className="text-2xl link link-hover"><BsInstagram></BsInstagram></a>
                            <a className="text-2xl link link-hover"><BsFacebook></BsFacebook></a>
                            <a className="text-2xl link link-hover"><FaTwitter></FaTwitter></a>
                            <a className="text-2xl link link-hover"><BsYoutube></BsYoutube></a>
                        </nav>
                    </div>
                </div>
                <div className='flex justify-around items-center'>
